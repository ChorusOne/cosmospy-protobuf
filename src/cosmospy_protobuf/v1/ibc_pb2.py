...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGIBCSEND']._serialized_start = 57
    _globals['_MSGIBCSEND']._serialized_end = 235
    _globals['_MSGIBCCLOSECHANNEL']._serialized_start = 237
    _globals['_MSGIBCCLOSECHANNEL']._serialized_end = 301